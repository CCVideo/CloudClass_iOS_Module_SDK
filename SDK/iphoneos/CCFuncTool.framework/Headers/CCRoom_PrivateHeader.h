...
//@abstract 房间分辨率限制
@property(nonatomic,assign,readwrite)NSInteger room_default_resolution;
@property(nonatomic,assign,readwrite)NSInteger room_max_resolution;
//房间服务类型
@property(nonatomic,assign,readwrite)CCRoomType room_server_type;
/**
 @abstract 房间级配置（学员订阅其他学员的流时：是否打开音频）*/
@property(nonatomic,assign,readwrite)NSInteger room_talker_audio;
