...
//    else
//    {
//        BOOL result = [[CCStreamerBasic sharedStreamer] changeRoomStudentBitrate:self.studentSlider.value completion:^(BOOL result, NSError *error, id info) {
//
//            if (result)
//            {
//                BOOL res = [[CCStreamerBasic sharedStreamer] changeRoomTeacherBitrate:weakSelf.teacherSlider.value completion:^(BOOL result, NSError *error, id info) {
//                    if (result)
//                    {
